        ...
        case "2":
            ...
            switch (menuOrden) {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    arrayOrdenAlfa(paises);
                    break;
            }
            break;
        case "3":
            mostrarIntervalo(paises);
            break;
        case "4":
            //Menu secundario
            ...
            switch (menuPais) {
                case "1":
                    ...
                    arrayInsertaPrincipio(paises);
                    break;

                case "2":
                    arrayInsertafinal(paises);
                    break;
            }
            break;
        case "5":
           ...
           switch (menuBorrar) {
                case "1":
                    arrayBorrarPrincipio(paises);
                    break;
                case "2":
                    arrayBorrarFinal(paises);
                    break;    
